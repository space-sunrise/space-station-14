...
public abstract partial class SharedStaminaSystem : EntitySystem
{
    ...
    public void UpdateStaminaVisuals(Entity<StaminaComponent> entity) // Sunrise-Edit: public для вампиров
    {
    ...
    public void ExitStamCrit(EntityUid uid, StaminaComponent? component = null) // Sunrise-Edit: public для вампиров
    {
        if (!Resolve(uid, ref component) ||
            !component.Critical)
        {
    ...
    public void AdjustStatus(Entity<StaminaComponent?> ent) // Sunrise-Edit: public для вампиров
    {
