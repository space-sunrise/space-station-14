...
public sealed class SharedSuicideSystem : EntitySystem
{
    ...
    public void ApplyLethalDamage(Entity<DamageableComponent> target, DamageSpecifier damageSpecifier)
    {
        ...
        _damageableSystem.ChangeDamage(target, appliedDamageSpecifier, true, origin: target, ignoreGlobalModifiers: true, ignoreVariance: true); // Sunrise-Edit
    }
    ...
    public void ApplyLethalDamage(Entity<DamageableComponent> target, ProtoId<DamageTypePrototype>? damageType)
    {
        ...
        _damageableSystem.ChangeDamage(target, damage, true, origin: target, ignoreGlobalModifiers: true, ignoreVariance: true); // Sunrise-Edit
    }
}
