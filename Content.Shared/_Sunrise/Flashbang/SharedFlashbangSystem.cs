...
public sealed class SharedFlashbangSystem : XOnTriggerSystem<FlashbangRadiusOnTriggerComponent>
{
    ...
    private void TryApplyFlashbangEffect(
        EntityUid source,
        EntityUid target,
        EntityUid? user,
        float realDistance,
