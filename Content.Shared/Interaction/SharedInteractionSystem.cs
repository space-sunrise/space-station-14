...
namespace Content.Shared.Interaction
{
    ...
    public abstract partial class SharedInteractionSystem : EntitySystem
    {
            ...
            bool needHand = true) // Sunrise-Edit
        {
            ...
            if (InteractDoAfter(user, used, target, clickLocation, canReach: true, needHand: needHand)) // Sunrise-Edit
                return true;
            return false;
        }
        ...
        ///     </param>
        /// <returns>True if the interaction was handled. Otherwise, false.</returns>
        public bool InteractDoAfter(EntityUid user, EntityUid used, EntityUid? target, EntityCoordinates clickLocation, bool canReach, bool needHand = true) // Sunrise-Edit
        {
