    ...
    public sealed partial class PaperWindow : BaseWindow
    {
        ...
        protected override void Draw(DrawingHandleScreen handle)
        {
            ...
            if (WrittenTextLabel.TryGetStyleProperty<Font>("font", out var font))
            {
                ...
                UpdateInteractiveTagLineHeight(fontLineHeight);
            }
        ...
        public void Populate(PaperComponent.PaperBoundUserInterfaceState state)
        {
            ...
            msg.AddMarkupPermissive(GetDisplayText(state, isEditing));
            ...
            WrittenTextLabel.SetMessage(msg, GetAllowedTags(), state.DefaultColor);

            WrittenTextLabel.Visible = !isEditing && state.Text.Length > 0;
            BlankPaperIndicator.Visible = !isEditing && state.Text.Length == 0;

            UpdateImageContent(state);
