...
using Robust.Client.UserInterface.Controls; // Sunrise-Edit
using Robust.Shared;
...
public sealed partial class AudioTab : Control
{
    ...
    public AudioTab()
    {
        ...
        Control.AddOptionCheckBox(ScpCCVars.EchoEnabled, EchoEnabledScpCheckBox); // Sunrise-Edit
        Control.AddOptionCheckBox(ScpCCVars.EchoStrongPresetPreferred, EchoStrongPresetPreferredScpCheckBox); // Sunrise-Edit

        Control.Initialize();

        ToggleEcho(); // Sunrise-Edit
    }
    ...
    protected override void EnteredTree()
    {
        ...
        EchoEnabledScpCheckBox.OnToggled += ToggleEcho; // Sunrise-Edit
    }
    ...
    {
        EchoStrongPresetPreferredScpCheckBox.Visible = EchoEnabledScpCheckBox.Pressed;
    }
    // Sunrise-End
