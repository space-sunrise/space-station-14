...
public sealed partial class RequirementsSelector : BoxContainer
{
    ...
    // Sunrise-Start
    /// <summary>
    /// Скрывает стандартный Label с названием должности и ставит на его место выпадающий список альт. названий.
    /// </summary>
    public void ReplaceTitleWith(Control control)
    {
        var idx = TitleLabel.GetPositionInParent();
        control.MinSize = TitleLabel.MinSize;
        control.ToolTip = TitleLabel.ToolTip;
        TitleLabel.Visible = false;
        AddChild(control);
        control.SetPositionInParent(idx);
    }
    // Sunrise-End
