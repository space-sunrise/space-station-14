...
public sealed partial class HumanoidProfileEditor
{
    ...
    private void OpenLoadout(JobPrototype? jobProto, RoleLoadout roleLoadout, RoleLoadoutPrototype roleLoadoutProto)
    {
        ...
        _loadoutWindow = CreateSunriseLoadoutWindow(Profile, roleLoadout, roleLoadoutProto, session, collection); // Sunrise-Edit — спонсорские лодауты
        _loadoutWindow.Title = Loc.GetString("loadout-window-title-loadout", ("job", $"{jobProto?.LocalizedName}"));
