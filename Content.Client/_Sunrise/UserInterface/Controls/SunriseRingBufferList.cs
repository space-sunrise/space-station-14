...
public sealed class SunriseRingBufferList<T> : IList<T>
{
    private T[] _items;
    private int _read;
    private int _write;
    ...
    {
        private readonly SunriseRingBufferList<T> _ringBufferList;
        private int _readPos;

        internal Enumerator(SunriseRingBufferList<T> ringBufferList)
        {
