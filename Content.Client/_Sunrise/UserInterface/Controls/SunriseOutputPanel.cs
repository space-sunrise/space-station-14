...
{
    [Virtual]
    public class SunriseOutputPanel : Control
    {
        ...
        {
            AddMessage(message, SunriseRichTextEntry.DefaultTags, defaultColor);
        }

        public void AddMessage(FormattedMessage message, Type[]? tagsAllowed, Color? defaultColor = null)
        {
            var entry = new SunriseRichTextEntry(message, this, _tagManager, tagsAllowed, defaultColor);
        ...
        {
            SetMessage(index, message, SunriseRichTextEntry.DefaultTags, defaultColor);
        }
        ...
        private void AddNewItemHeight(Font font, in SunriseRichTextEntry entry)
        {
