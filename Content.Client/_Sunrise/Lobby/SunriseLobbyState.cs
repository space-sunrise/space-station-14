...
{
    public sealed class SunriseLobbyState : Robust.Client.State.State
    {
        ...
        private void RefreshServersHubHeader(List<ServerHubEntry> servers)
        {
            ...
            Lobby!.ServersHubHeaderLabel.Text = Loc.GetString("serverhub-playingnow", ("total", totalPlayers), ("max", maxPlayers));
        }
        ...
        private void OnReadyPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            new SRLateJoinGui().OpenCentered();
        }
