...
public sealed partial class ExtraTab : Control
{
    ...
    public ExtraTab()
    {
        ...
        Control.AddOption(new SunriseOptionDropDownCVar<int>(
            Control,
            _cfg,
            CCVars.ParticleQuality,
            DropDownParticleQuality,
            [
                new(0, Loc.GetString("ui-options-particles-off")),
                new(1, Loc.GetString("ui-options-particles-low")),
                new(2, Loc.GetString("ui-options-particles-medium")),
                new(3, Loc.GetString("ui-options-particles-high")),
            ]));
