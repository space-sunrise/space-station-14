...
{
    /// <summary>
    /// Main control of the mentor help interface.
    /// </summary>
    ...
    public sealed partial class MentorHelpControl : Control
    {
        ...
        /// <summary>
        /// Tries to open a ticket by ID.
        /// Requests the ticket list if not loaded yet.
        /// </summary>
        ...
        private void UpdateTeleportButton()
        {
            ...
            TeleportButton.Visible = canTeleport;
            TeleportButton.Disabled = !canTeleport;
        }
        ...
        private void TeleportToTicket()
        {
            if (_selectedTicket?.PlayerEntity is not { Valid: true } playerEntity)
                return;

            if (!CanTeleportToTicket())
                return;
        ...
        private bool CanTeleportToTicket()
        {
            ...
            var isAdminGhost = _player.LocalEntity is { Valid: true } localEntity &&
                _entManager.TryGetComponent(localEntity, out GhostComponent? ghost) &&
                ghost.CanGhostInteract;

            return _hasMentorPermissions && canUseTeleportCommands && isAdminGhost;
        }
