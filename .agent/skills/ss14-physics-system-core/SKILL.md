...
- Текстовая документация по физике полезна как вводная, но может отставать.
- Источник правды для поведения и сигнатур: текущий код движка и актуальные вызовы в системах контента ✅
