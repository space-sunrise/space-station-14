...
## 15) Замечание по источнику истины

- При расхождениях текстовой документации и поведения методов ориентируйся на текущие сигнатуры и фактическую логику в коде движка/систем.
