...
Их вызывает `.github/workflows/publish-sunrise.yml`; Stable и Test используют тот же сценарий.
GitHub требует хранить сценарии непосредственно в `.github/workflows`, поэтому для них используется суффикс `-sunrise`.
