    ...
    public sealed class DestructibleThresholdActivationTest
    {
        ...
        public async Task Test()
        {
            ...
            await server.WaitAssertion(() =>
            {
                ...
                sDamageableSystem.ChangeDamage(sDestructibleEntity, bluntDamage, true, ignoreGlobalModifiers: true, ignoreVariance: true); // Sunrise-Edit
                ...
                sDamageableSystem.ChangeDamage(sDestructibleEntity, bluntDamage * 3, true, ignoreGlobalModifiers: true, ignoreVariance: true); // Sunrise-Edit
                ...
                sDamageableSystem.ChangeDamage(sDestructibleEntity, bluntDamage * 5, true, ignoreGlobalModifiers: true, ignoreVariance: true); // Sunrise-Edit
                ...
                sDamageableSystem.ChangeDamage(sDestructibleEntity, bluntDamage * 10, true, ignoreGlobalModifiers: true, ignoreVariance: true); // Sunrise-Edit
                ...
                sDamageableSystem.ChangeDamage(sDestructibleEntity, bluntDamage * -4, true, ignoreGlobalModifiers: true, ignoreVariance: true); // Sunrise-Edit
