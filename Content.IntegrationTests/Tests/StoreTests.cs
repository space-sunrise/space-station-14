    ...
    public async Task StoreDiscountAndRefund()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            Assert.That(
                ...
                $"After applying discount total discounted items count was expected to be '10' "
                ...
                + $"discounted count being changed from '10' in StoreDiscountSystem.InitializeDiscounts."
            ); // Sunrise-edit
