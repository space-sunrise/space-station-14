...
public sealed partial class TTSSystem
{
    ...
    private static readonly IReadOnlyDictionary<string, string> WordReplacement =
        new Dictionary<string, string>()
        {
            ...
            {"срп", "книга анекдотов"},
            {"цк", "Центр Коррупции"},
            {"сцк", "Станция Центра Коррупции"},
            {"пцк", "Представитель Центра Коррупции"},
            {"оцк", "Оператор Центра Коррупции"},
            {"шцк", "Штаб Центра Коррупции"},
            {"ншцк", "Начальник Штаба Центра Коррупции"},
            {"дсо", "Дэ Эс О"},
            {"рнд", "Очкарики"},
            {"нио", "Очкарики"},
            ...
            {"тсф", "Тэ Эс Эф"},
            {"срт", "Эс Эр Тэ"},
            {"обр", "Отряд Боевых Революционнеров"},
            {"кпк", "Поко Икс 3"},
            {"пда", "Поко Икс 3"},
            {"id", "Ай Ди"},
            {"мщ", "Эм Ще"},
