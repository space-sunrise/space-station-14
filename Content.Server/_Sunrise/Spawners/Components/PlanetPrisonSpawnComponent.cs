...
/// Это позволяет системе спавна Планетарной Тюрьмы более точно выбирать места для ролей.
/// </summary>
[RegisterComponent]
public sealed partial class PlanetPrisonSpawnComponent : Component
{
    /// <summary>
    /// Список типов спавна, которые эта точка спавна Планетарной Тюрьмы предпочитает.
    ...
    /// но с определенными приоритетами, которые обрабатывает PlanetPrisonSpawnSystem.
    /// </summary>
    [DataField]
