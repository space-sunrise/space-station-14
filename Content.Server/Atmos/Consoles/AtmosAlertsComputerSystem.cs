...
public sealed partial class AtmosAlertsComputerSystem : SharedAtmosAlertsComputerSystem
{
    ...
    [Dependency] private SharedAudioSystem _audio = default!; // Sunrise edit
    [Dependency] private PowerCellSystem _cell = default!; // Sunrise edit
    [Dependency] private IGameTiming _gameTiming = default!; // Sunrise edit
