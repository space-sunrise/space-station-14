...
public sealed class StationRecordsSystem : SharedStationRecordsSystem
{
        ...
        bool silicon = false) // Sunrise-Edit
    {
        ...
        var record = new GeneralStationRecord()
        {
            ...
            EmploymentRecord = EnsureRequiredEducation(profile.EmploymentRecord, jobId),
    ...
    private string EnsureRequiredEducation(string employmentRecord, string jobId)
    {
        ...
        record.Education.Add(new EducationRecordData
        {
            ...
            DiplomaDate = (2530 + _random.Next(0, 40)).ToString(),
        });
