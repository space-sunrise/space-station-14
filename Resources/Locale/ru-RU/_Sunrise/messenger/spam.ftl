...
messenger-spam-events-message-4 = Только лучшие аниматоры со всего сектора! Специализированные конкурсы для сотрудников Nanotrasen! Посвящение в капитаны! Торт для начальника собаки безопасности!
...
messenger-spam-emergency-message-1 = я врезался в корабль и пес говорит что можно всё замять за 10000 кредитов, переведи пожалуйста
...
messenger-spam-error-message-3 = …ася, хватить, блядь! Водки он напился, идиот. У НАС ЗАВТРА НА ТРАНС СОЛНЕЧНУЮ ФЕДЕРАЦИЮ НАЛЁТ, КАКАЯ ВОДКА! Сука, пес СССП ещё называе…
