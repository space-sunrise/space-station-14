reagent-name-desoxyephedrine = эфедрин
...
reagent-name-ephedrine = ноктюрин
...
reagent-name-stimulants = дезоксиэфедрин
...
reagent-name-experimental-stimulants = счастье
...
reagent-name-nicotine = внеземной ноктюрин
...
reagent-name-space-drugs = норэпинефриновая кислота
reagent-desc-space-drugs = Запрещённое вещество, вызывающее ряд таких эффектов, как потеря равновесия и нарушения зрения.
reagent-name-nocturine = токсин немоты
reagent-name-nocturine-abductor = гиперзин
...
reagent-name-mute-toxin = слезоточивый газ
...
reagent-name-norepinephric-acid = экспериментальный стимулятор
...
reagent-name-tear-gas = космический мираж
