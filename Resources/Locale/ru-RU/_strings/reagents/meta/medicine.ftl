reagent-name-apoptodon = Апоптодон
reagent-desc-apoptodon = Продвинутый радиоактивный раствор для регенерации тела в холодных условиях. Замедляет разложение, но вызывает радиационные и клеточные повреждения. Работает как на мёртвых, так и на живых.
...
reagent-name-vitera = Витера
reagent-desc-vitera = Специализированный боевой препарат, напрямую лечащий повреждения от истощения. Эффективен для борьбы с утомлением и метаболическим истощением.
reagent-name-genesis-ultra = Генезис-Ультра
reagent-desc-genesis-ultra = Передовое средство для лечения истощения, обеспечивающее быстрое заживление, но вызывающее генетические повреждения в качестве побочного эффекта. Используйте с осторожностью.
