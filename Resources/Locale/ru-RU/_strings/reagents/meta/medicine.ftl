...
reagent-desc-antidon = Криогенный специализированный реагент для лечения отравлений, эффективно нейтрализующий токсические повреждения. Работает как на мёртвых, так и на живых.
