...
reagent-desc-h-32 = Продвинутое радиоактивное решение для регенерации тела в холодных условиях. Замедляет разложение, но вызывает радиационные и клеточные повреждения. Работает как на мёртвых, так и на живых.
