...
reagent-desc-heparin = Широко используется в качестве антикоагулянта. Затрудняет образование сгустков крови, разжижая её; при передозировке может вызывать внутреннее кровотечение.
