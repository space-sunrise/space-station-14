...
reagent-desc-h-32 = Реагент, разработанный в полевых условиях с повышенной радиацией. Работает как на мёртвых, так и на живых.

reagent-name-antidon = Антидон
reagent-desc-antidon = Специализированный реагент для лечения отравлений, эффективно нейтрализующий токсические повреждения. Работает как на мёртвых, так и на живых.

reagent-name-brutedon = Брутедон
reagent-desc-brutedon = Передовое средство для лечения механических повреждений, заживляющее все типы физических травм. Работает как на мёртвых, так и на живых.
