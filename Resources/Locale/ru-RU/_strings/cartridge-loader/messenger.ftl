...
messenger-tab-invites = Приглашения
messenger-no-invites = Нет приглашений
...
messenger-invite-member-button = Пригласить
messenger-invites-header = Приглашения
messenger-invite-info = { $inviter } приглашает вас
messenger-invite-accept = Принять
messenger-invite-decline = Отклонить
messenger-invite-user-to-group-title = Пригласить в { $groupName }
