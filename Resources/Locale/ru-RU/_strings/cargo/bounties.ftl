...
bounty-description-cardboard-box = «Пришествие кардборгов» — новая постановка, премьера которой состоится завтра, а костюмный отдел совершенно не готов. Отправьте нам несколько коробок для работы.
