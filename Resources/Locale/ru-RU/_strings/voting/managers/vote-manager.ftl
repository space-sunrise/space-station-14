...
ui-vote-gamemode-tie = Ничья в голосовании за игровой режим! Выбирается случайный режим...
ui-vote-gamemode-win = Голосование за игровой режим закончено!
ui-vote-map-title = Следующая карта
ui-vote-map-tie = Ничья при голосовании за карту! Выбирается случайная карта...
...
ui-vote-votekick-success = Голосование за кик { $target } успешно. Причина: { $reason }
