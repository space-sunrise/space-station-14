...
uplink-access-breaker-name = Обходчик доступа
uplink-access-breaker-desc = Взломанный ID-конфигуратор, верный напарник Э-Мага. Принудительно открывает шлюзы и сбрасывает уровни доступа. Автоперезарядка.
