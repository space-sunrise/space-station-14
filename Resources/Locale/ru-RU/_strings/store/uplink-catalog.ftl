...
uplink-business-card-desc = Визитная карточка, которую можно подарить кому-нибудь, чтобы продемонстрировать свою причастность к синдикату, или оставить на месте преступления, чтобы подшутить над ищейкой. Вы можете купить не более трех таких визиток.
