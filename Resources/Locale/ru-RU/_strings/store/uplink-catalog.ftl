...
uplink-l6-saw-bundle-desc = Ещё больше дакки: культовый лёгкий пулемёт L6 в комплекте с 3 коробами патронов по 150 патронов каждый. Штурмовая версия что овершенно не сковывает движение, ценой точности.
