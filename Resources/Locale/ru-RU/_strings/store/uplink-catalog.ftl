...
uplink-cane-shotgun-desc = Трость со спрятанным однозарядным дробовиком, поставляется в коробке с 5-ю опьяняющими патронами, патроны вызывают сонливость, интоксикацию и галюцинации а так же накладывает молчание.
# Armor
