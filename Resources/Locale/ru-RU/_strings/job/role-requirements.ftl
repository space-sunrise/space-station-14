...
role-banned-locked = Недоступно (наведите курсор, чтобы узнать подробности)
role-banned-expiration = Истекает: { $expiration }
role-banned-permanent = Бессрочный запрет { $appealDetails }
role-banned-reason = Причина: { $reason }
