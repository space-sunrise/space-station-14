...
ghost-role-information-exterminator-description = Вы были отправлены в прошлое, чтобы уничтожить цель, имеющую огромное значение для будущего.
ghost-role-information-exterminator-rules = Вы являетесь антагонистом и можете убивать всех, кто попытается вас остановить, но уничтожение цели всегда должно быть вашим главным приоритетом.
