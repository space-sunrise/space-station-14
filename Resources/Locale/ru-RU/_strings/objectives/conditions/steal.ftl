...
ent-AnimalTropico = Тропико
ent-AnimalMorty = Морти
ent-AnimalShiva = Шива
ent-AnimalIan = Иан
ent-AnimalWalter = Уолтер
ent-AnimalMcGriff = МакГрифф
ent-AnimalNamedCat = Бингус
ent-DoorRemote = Пульт от шлюзов
ent-IDCard = ID карты
ent-Stamp = Печати
