...
alert-level-psi = Пси
alert-level-psi-announcement = Избегайте киборгов, не соответствующих спецификациям NanoTrasen. Не перемещайтесь по станции в одиночку. Обратитесь к главам отделов за дальнейшими указаниями.
