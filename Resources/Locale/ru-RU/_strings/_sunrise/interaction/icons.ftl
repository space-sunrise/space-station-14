...
interaction-icon-name-wing-pat = Поглаживание крыльев
interaction-icon-name-wing-scratch = Почесывание крыльев
interaction-icon-name-wing = Крылья
interaction-icon-name-wing-pull = Дернуть за крылья