...
job-description-surgeon = Врач, который занимается прижизненной и посмертной диагностикой трупа, проводит операции и устанавливает кибернетические импланты.
