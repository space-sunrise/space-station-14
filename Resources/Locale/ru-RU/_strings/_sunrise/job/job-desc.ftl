...
job-description-ntrg = Вы являетесь опорой и защитой Юридического Департамента, выполняя решения и постановления самого Магистрата и Представителя НаноТрейзен!
job-description-ntrofficer = Вы являетесь опорой и защитой Юридического Департамента, выполняя решения и постановления самого Магистрата и Представителя НаноТрейзен!
