...
job-description-ntrg = Вы являетесь опорой и защитой Юридического Департамента, выполняя решения и постановления самого Магистрата и Представителя нанотрейзена!
job-description-ntrofficer = Вы являетесь опорой и защитой Юридического Департамента, выполняя решения и постановления самого Магистрата и Представителя нанотрейзена!
job-description-usspcaptain = Управляйте лучшим местом в космосе. Родина зовёт!
job-description-miningspec = Оставайтесь на станции и обогащайте её материалами, используя свой магнит утилизатора и переработчик руды.
