code-console-verb-seale-name = запечатать порты
code-console-verb-seal-desc = Закрывает доступ к портам, делая невозможным перепривязать устройства.
...
code-console-user-interface-lock-button = Закрыть
