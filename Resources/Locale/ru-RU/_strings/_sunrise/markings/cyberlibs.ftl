...
# Nanotrasen
marking-CyberlimbRArmNanotrasen = Протез, правая рука (НаноТрейзен)
marking-CyberlimbLArmNanotrasen = Протез, левая рука (НаноТрейзен)
marking-CyberlimbRHandNanotrasen = Протез, кисть правой руки (НаноТрейзен)
marking-CyberlimbLHandNanotrasen = Протез, кисть левой руки (НаноТрейзен)
marking-CyberlimbRLegNanotrasen = Протез, правая нога (НаноТрейзен)
marking-CyberlimbLLegNanotrasen = Протез, левая нога (НаноТрейзен)
marking-CyberlimbRFootNanotrasen = Протез, правая стопа (НаноТрейзен)
marking-CyberlimbLFootNanotrasen = Протез, левая стопа (НаноТрейзен)
marking-CyberlimbTorsoNanotrasen = Протез, туловище (НаноТрейзен)
# Xion
