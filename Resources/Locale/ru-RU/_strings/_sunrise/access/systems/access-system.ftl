...
access-system-accesses-delay-blue = Зафиксировано установление синего кода! Запущен протокол автоматической перезаписи доступов. авоступы прошлого кода будут стёрты. Сотрудники службы безопасности получат дополнительные доступы в технические помещения через 1 минуту.
