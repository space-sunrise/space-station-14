...
ent-ClothingBlueShieldModsuit = Р.И.Г. пса «Синий щит»
...
ent-ClothingModsuitERTSecurity = Р.И.Г. ОБР
    .desc = Бронированный Р.И.Г военной модели, разработанный для пса отряда центрального командования. Обеспечивает защиту от большинства угроз, встречающихся в открытом космосе и при выполнении оперативных задач.
...
ent-ClothingModsuitBlueshield = Р.И.Г пса «Синий щит»
