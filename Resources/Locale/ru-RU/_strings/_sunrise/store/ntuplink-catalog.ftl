...
ntuplink-mech-teleporter-eliteheavy-desc = Содержит ящик с лучшим мехом NanoTrasen. Доступен только для самых опасных миссий. Только для старших Офицеров!
ntuplink-mech-powercage-nanotrasen-name = Энерго ячейка NanoTrasen
