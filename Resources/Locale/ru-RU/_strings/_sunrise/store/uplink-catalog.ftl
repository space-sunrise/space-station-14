...
uplink-SyndieBreachingHammer-name = таран синдиката
uplink-SyndieBreachingHammer-desc = Большой, тяжёлый молот с длинной рукояткой. Для камней, черепов, стен, костей — без разницы. Последнее, что вы услышите — хруст или скрежет. Шлюзы открывает лучше тарана СБ. У конкурентов — краш-тесты и сертификаты. У нас — бюджетная снафф-пародия на Американского психопата.
