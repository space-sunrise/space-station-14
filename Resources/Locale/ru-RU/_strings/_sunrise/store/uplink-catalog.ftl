...
uplink-l6-sawmax-bundle-desc = Пулемёт в комплекте с тремя коробами патронов на 100. Усиленный ствол и мощный калибр .308 позволяют подавлять противника шквальным огнём и разносить укрытия в щепки. За сокрушительную мощь приходится расплачиваться громоздкостью и сниженной скоростью передвижения.
