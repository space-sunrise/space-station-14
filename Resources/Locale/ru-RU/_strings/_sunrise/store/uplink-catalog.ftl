...
uplink-energy-dome-grenade-name = Переносной генератор щита
uplink-energy-dome-grenade-desc = Генератор щита, развёртывающий временно энерго поле. Работает в течении 180 секунд с момента установки, примерная прочность щита около 150 выстрелов 5,56.
