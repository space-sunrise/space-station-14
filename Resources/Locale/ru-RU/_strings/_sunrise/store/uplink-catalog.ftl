...
uplink-mech-equipment-kord-name = ящик с «Кордом»
uplink-mech-equipment-kord-desc = Ящик с навесным пулемётом «Корд» под патрон 12,7 x 108 мм и двумя запасными патронными лентами.
