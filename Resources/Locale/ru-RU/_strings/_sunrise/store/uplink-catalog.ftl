...
uplink-weapon-ussp-dmr-desc = Снайперская винтовка под патроны калибра 7,62x54R с десятью магазинами разных типов. Предназначена для стрельбы на дальние дистанции.
