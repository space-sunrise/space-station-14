...
uplink-med-hypospray-desc = Стерильный инжектор для быстрого введения лекарств пациентам. До взлрома содержал внутренний фильтр токсинов. Теперь не содержит.
## Implats
