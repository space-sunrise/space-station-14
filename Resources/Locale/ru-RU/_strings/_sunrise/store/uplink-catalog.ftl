...
uplink-ammo-lmgkit-name = Набор коробов .308 для L6 MAX
uplink-ammo-lmgkit-desc = Перезаряжаю! Содержит короба патронов .308 для L6 MAX.
uplink-ammo-lmgincendiarykit-name = Набор зажигательных коробов .308 для L6 MAX
uplink-ammo-lmgincendiarykit-desc = Перезаряжаю! Содержит короба зажигательных патронов .308 для L6 MAX.
uplink-ammo-lmguraniumkit-name = Набор урановых коробов .308 для L6 MAX
uplink-ammo-lmguraniumkit-desc = Перезаряжаю! Содержит короба урановых патронов .308 для L6 MAX.
