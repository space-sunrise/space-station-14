...
uplink-experimental-eshield-desc = Ещё более экзотический энергощит, отражающий почти все лазерные лучи, а также немного защищающий от пуль и других физических атак. Имеет встроенную самозаряжающуюся батарею, но после нескольких циклов активной зарядки и разрядки корпус щита всё же может сломаться.
...
uplink-mech-teleporter-assault-desc = Содержит лёгкий боевой мех «Киберсан Дарк Гигакс», ремонтный ящик с инструментами Синдиката и игрушечный «Гигакс». Мех прибывает с текущим встроенным оснащением.
uplink-rover-assembly-crate-name = ящик для сборки Ровера
uplink-rover-assembly-crate-desc = Содержит шасси Дюранда, бронепластины Ровера, электронные модули управления, продвинутый передатчик и ремонтный набор инструментов Синдиката. Остальные общие детали меха необходимо получить отдельно.
