...
uplink-magazine-127-desc = Магазин для Bauer SR-127. Вмещает 7 патронов 15х115мм предназначеных для уничтожения мехов, киборгов или стркутур таких как решетки и окна, пары попаданий достаточно для пролома стены.
uplink-magazine-127pen-desc = Магазин для Bauer SR-127. Вмещает 7 патронов 15х115мм предназначеных для ликвидации защищенных противников а так же целей за укрытиями и стенами, прекрасно сочетаются с термальным зрением.
uplink-magazine-127emp-desc = Магазин для Bauer SR-127. Вмещает 7 патронов 15х115мм предназначеных для вывода из строя электроники, отключения датчиков а так же глушения радио сигнала, наносят повреждения мехам и отключает модули в радиусе 2-х клеток от попадания.
uplink-magazine-127frag-desc = Магазин для Bauer SR-127. Вмещает 7 патронов 15х115мм предназначеных для поражения живой силы противника, в месте попадания происходит небольшой взрыв раскидывая в небольшом радиусе смертельные осколки.
uplink-magazine-127blast-desc = Магазин для Bauer SR-127. Вмещает 7 патронов 15х115мм. Удачи, не подорвите сами себя.
...
uplink-mech-missle-rack8frag-desc = Старые ракеты на мех, схожие с теми, что используют мехи синдиката. Имеют хороший радиус взрыва и отличное осколочное действие по сравнению со стандартными ракетами.
