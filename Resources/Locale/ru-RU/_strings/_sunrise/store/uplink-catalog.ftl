...
uplink-mech-teleporter-death-desc = Содержит тяжелобронированный мех АВП MK-II, не идет с какими либо модулями но имеет ящик для базового обслуживания. Докажите Службе безопастности что ваша "Смерть-дозер" круче их Падди.
...
uplink-mech-missle-rack8frag-desc = Старые ракеты на мех, схожие как те что используют мехи синдиката. Имеют хороший радиус взрыва и отличное осколочное действие свойства ракет по сравнению со стандартными ракетами.
