...
ent-AmpulaBuccaneerSpirit = { ent-Ampula }
    .suffix = дух буканьера
    .desc = Пиратская ампула, наполненная подозрительно бодрящей смесью для экстренных случаев.
ent-AmpulaMurmillo = { ent-Ampula }
    .suffix = мурмилло
    .desc = Запечатанная ампула с восстанавливающейся боевой стимулирующей смесью.
ent-AmpulaPirate = пиратская ампула
    .desc = Усиленная пиратская ампула для систем экстренной инъекции скафандра.
