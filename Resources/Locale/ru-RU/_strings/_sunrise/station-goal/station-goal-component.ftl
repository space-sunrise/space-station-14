...
station-goal-reconnaissance-in-force = [bold]Форма НТ/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀⠀
    ⠀[italic]Место для печатей[/italic]
station-goal-reports = [bold]Форма НТ/КОМ-ЦК-ПЦС[/bold]    ⠀[head=3]Приказ Центрального Командования[/head]
...
station-goal-church = [bold]Форма НТ/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀[italic]Центральное Командование дополнительно уведомляет о возможном наличии на объекте сотрудника Центрального Командования — Представителя НаноТрейзен и уполномоченно сотрудника Департамента внутреннего надзора — Агента Внутренних Дел. Мы требуем полного содействия данным лицам во всех вопросах.[/italic]
    ⠀⠀
    ⠀[italic]Место для печатей[/italic]    ⠀[italic]Срок исполнения: 2 часа[/italic]
    ...
    ⠀Настоящим приказом в соответствии с «Общими положениями информирования Секторальных Штабов Командования» и «Нормами приоритизации указаний (приказов)», на основании установленных процедур, Центральное Командование ставит перед Командованием вашего объекта задачу на текущую смену.    ⠀В вашем секторе начинаются плановые проверки для оценки эффективности и обоснования дальнейшего финансирования.
...
station-goal-church = [bold]Форма НТ/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀[italic]Центральное Командование дополнительно уведомляет о возможном наличии на объекте сотрудника Центрального Командования — Представителя НаноТрейзен и уполномоченно сотрудника Департамента внутреннего надзора — Агента Внутренних Дел. Мы требуем полного содействия данным лицам во всех вопросах.[/italic]
    ⠀⠀
    ⠀[italic]Место для печатей[/italic]    ⠀В вашем секторе начинаются плановые проверки для оценки эффективности и обоснования дальнейшего финансирования.
