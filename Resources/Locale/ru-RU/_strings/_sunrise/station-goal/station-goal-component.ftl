...
station-goal-weapon-sec = [bold]Форма НТ/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ваша Цель смены — [bold]вооружение Службы Безопасности передовым оружием[/bold].    ⠀[italic]Установленная Цель смены может быть заменена, отменена или пересмотрена в ходе смены по решению Центрального Командования в одностроннем порядке.[/italic]
