...
station-goal-shuttle =⠀​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Составитель документа: Эбигейл Смэллс
     Должность составителя: Пес Центрального Командования
...
station-goal-containment = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Инженерный отдел, Отдел Снабжения, Научный отдел, Собака безопасности, Капитан объекта { $station }[/bold].
...
station-goal-delta-ambusol = [bold]Форма NT/КОМ-ЦК-СИТ-ОМЕГА[/bold]
    ...
    ⠀Ответственные за цель: [bold]Капитан, Глава Собаки безопасности, Главный Врач, Старший Инженер, Квартирмейстер объекта { $station }[/bold].
    ⠀⠀
    ⠀​[italic]Место для печатей[/italic]
station-goal-weapon-sec = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ваша Цель смены — [bold]вооружение Собаки безопасности передовым оружием[/bold].
    ...
    ⠀— [bold]Отделу Снабжения:[/bold] обеспечить проект всеми необходимыми материалами.
    ⠀— [bold]ВАЖНО:[/bold] Глава Собаки безопасности уполномочен самостоятельно определить перечень изучаемых технологий и составить список образцов оружия, подлежащих разработке в рамках данной цели. Использование данного оружия разрешено только сотрудникам Собаки безопасности.

    ⠀Ответственные за цель: [bold]Научный отдел, Собака безопасности, Капитан объекта { $station }[/bold].
...
station-goal-battle-shuttle = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ваша Цель смены — [bold]постройка управляемого боевого шаттла для Собаки безопасности[/bold].
...
station-goal-transit-time = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Инженерный отдел, Отдел Снабжения, Научный отдел, Собака безопасности, Медицинский отдел, Сервисный отдел, Капитан объекта { $station }[/bold].
...
station-goal-nuke-room = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Инженерный отдел, Отдел Снабжения, Собака безопасности, Капитан объекта { $station }[/bold].
...
station-goal-training-crew = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Инженерный отдел, Научный отдел, Отдел Снабжения, Сервисный отдел, Собака безопасности, Медицинский отдел, Капитан объекта { $station }[/bold].
...
station-goal-creation-of-furs = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Научный отдел, Отдел Снабжения, Собака безопасности, Капитан объекта { $station }[/bold].
...
station-goal-saboteurs = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Главе Собаки безопасности:[/bold] выбрать до двух членов экипажа на роль "диверсантов".
    ...
    ⠀​[italic]Центральное Командование напоминает, что данные учения являются прямой оценкой боеготовности вашей Собаки безопасности. Неспособность выявить и нейтрализовать учебных диверсантов будет зафиксирована как провал аттестации и повлечет за собой административные выводы в отношении Главы Собаки безопасности и Капитана. Мы ожидаем максимальной демонстрации профессионализма. Слава NanoTrasen![/italic]

    ⠀​[italic]Центральное Командование дополнительно уведомляет о возможном наличии на объекте сотрудника Центрального Командования — Представителя NanoTrasen и уполномоченного сотрудника Департамента внутреннего надзора — Агента Внутренних Дел. Мы требуем полного содействия данным лицам во всех вопросах.[/italic]

    ⠀Ответственные за цель: [bold]Собака безопасности, Капитан объекта { $station }[/bold].
    ⠀⠀
    ⠀​[italic]Место для печатей[/italic]
...
station-goal-reports = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Отдел Снабжения, Инженерный отдел, Научный отдел, Медицинский отдел, Собака безопасности, Сервисный отдел, Командование, Капитан объекта { $station }[/bold].
...
station-goal-intelligent-weapons = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Отдел Снабжения, Сервисный отдел, Научный отдел, Медицинский отдел, Собака безопасности, Инженерный отдел, Капитан объекта { $station }[/bold].
    ⠀⠀
    ⠀​[italic]Место для печатей[/italic]
...
station-goal-testing-sb = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ваша Цель смены — [bold]комплексное тестирование Собаки безопасности[/bold].

    ⠀​[italic]Установленная Цель смены может быть заменена, отменена или пересмотрена в ходе смены по решению Центрального Командования в одностороннем порядке.[/italic]

    ⠀— [bold]Капитану объекта { $station }:[/bold] провести полную аттестацию для всего состава собаки безопасности, включая: тесты на знание СРП и КЗ, учения по разминированию, стрельбе, прохождению полосы препятствий, оценку навыков управления мехами и действий при ЧС.
...
station-goal-delegates = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Медицинский отдел, Сервисный отдел, Инженерный отдел, Отдел Снабжения, Научный отдел, Собака безопасности, Капитан объекта { $station }[/bold].
...
station-goal-church = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Сервисный отдел, Инженерный отдел, Собака безопасности, Отдел Снабжения, Капитан объекта { $station }[/bold].
...
station-goal-sample-collection = ​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Инженерный отдел, Научный отдел, Медицинский отдел, Собака безопасности, Отдел Снабжения, Капитан объекта { $station }[/bold].
...
station-goal-virology = ​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Инженерный отдел, Научный отдел, Медицинский отдел, Сервисный отдел, Собака безопасности, Отдел Снабжения, Капитан объекта { $station }[/bold].
...
station-goal-health-examination = ​[bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀Ответственные за цель: [bold]Инженерный отдел, Медицинский отдел, Собака безопасности, Отдел Снабжения, Капитан объекта { $station }[/bold].
