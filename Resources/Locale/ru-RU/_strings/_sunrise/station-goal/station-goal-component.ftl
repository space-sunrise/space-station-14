...
station-goal-mining-outpost = [bold]Форма NT/КОМ-ЦК-ПЦС[/bold]
    ...
    ⠀— [bold]Сервисному отделу:[/bold] подготовить 40 нераскрытых алюминиевых банок с пивом, 300u безалкогольных напитков, двадцать блюд и перенести всё перечисленное в аванпост.
    ⠀— [bold]Научному отделу:[/bold] разработать необходимые платы и технологии.
