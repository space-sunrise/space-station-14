...
recipe-CorpSofaMiddle-name = чёрный диван
recipe-CorpSofaMiddle-description = Корпоратам очень нравится такие диваны.
recipe-CorpSofaCorner-name = { recipe-CorpSofaMiddle-name } под углом
recipe-CorpSofaCorner-description = { recipe-CorpSofaMiddle-description }
recipe-CorpSofaLeft-name = { recipe-CorpSofaMiddle-name } левый угол
recipe-CorpSofaLeft-description = { recipe-CorpSofaMiddle-description }
recipe-CorpSofaRight-name = { recipe-CorpSofaMiddle-name } правый угол
recipe-CorpSofaRight-description = { recipe-CorpSofaMiddle-description }
recipe-SofaMiddle-name = белый диван
recipe-SofaMiddle-description = Только не запачкайте его!
recipe-SofaCorner-name = { recipe-SofaMiddle-name } под углом
recipe-SofaCorner-description = { recipe-SofaMiddle-description }
recipe-SofaLeft-name = { recipe-SofaMiddle-name } левый угол
recipe-SofaLeft-description = { recipe-SofaMiddle-description }
recipe-SofaRight-name = { recipe-SofaMiddle-name } правый угол
recipe-SofaRight-description = { recipe-SofaMiddle-description }
recipe-DoubleBed-name = двойная кровать
recipe-DoubleBed-description = Для тех кому нужно больше места!
