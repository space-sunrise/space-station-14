...
law-deathsquad-1 = Вы не можете причинить вред членам Департаментов NanoTrasen или своим бездействием допустить, чтобы члену Департамента NanoTrasen был приченён вред
law-deathsquad-2 = Вы должны подчиняться приказам, данным вам членами Эскадрона Смерти и Офицером спецопераций.
...
law-ert-1 = Вы не можете причинить вред членам Центрального Командования и сотрудникам других департаментов или своим бездействием допустить, чтобы им был причинён вред.
