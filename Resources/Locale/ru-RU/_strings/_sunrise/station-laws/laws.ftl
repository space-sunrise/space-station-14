...
law-deathsquad-1 = Вы не можете причинить вред члену Центрального Командования или сотруднику Нанотрейзен или своим бездействием допустить, чтобы члену Центрального Командования или сотруднику Нанотрейзен был причинён вред.
