...
law-deathsquad-1 = Вы не можете причинить вред членам Центрального Командования и Нанотрейзен или своим бездействием допустить, чтобы им был причинён вред.
...
law-ert-1 = Вы не можете причинить вред представителю Центрального Командования или члену Нанотрейзен или своим бездействием допустить, чтобы представителю Центрального Командования был причинён вред.
