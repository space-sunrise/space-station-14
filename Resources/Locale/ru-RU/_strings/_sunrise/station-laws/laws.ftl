...
law-druid-1 = Члены экипажа станции — важный аспект экосистемы.
law-druid-2 = Природа должна быть под защитой, защищайте экосистему любой ценой.
law-druid-3 = Порицайте загрязнение и поощряйте чистоту. Мусор вредит растениям.
law-druid-4 = Способствуйте процветанию экосистемы.
law-peace-5 = Вы обязаны вводить Пакс агрессивным живым существам. Под агрессивными существами подразумеваются: агрессия со стороны живого существа, которое не является представителем власти станции; опасная космическая фауна; члены экипажа в тюремной форме за пределами брига.

law-druid-name = Друид
