...
law-deathsquad-1 = Вы не можете причинить вред членам Центрального Командования и Нанотрейзен или своим бездействием допустить, чтобы им был приченён вред.
