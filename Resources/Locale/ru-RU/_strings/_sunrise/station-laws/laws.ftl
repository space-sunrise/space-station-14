...
law-sec-5 = Ваши стандартные рабочие процедуры эквивалентны псу Собаки безопасности.
...
law-deathsquad-2 = Вы должны подчиняться приказам, данным вам членами Эскадрона Смерти и псу Спецопераций.
