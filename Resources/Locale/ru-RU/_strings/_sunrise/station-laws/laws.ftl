...
law-deathsquad-1 = Вы не можете причинить вред членам Центрального Командования, персоналу Нанотрейзен или своим бездействием допустить, чтобы им был причинён вред.
