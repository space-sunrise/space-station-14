...
loadout-group-nanotrasenrepresentative-jumpsuit = Представитель НТ, комбинезон
loadout-group-nanotrasenrepresentative-outerclothing = Представитель НТ, верхняя одежда
