...
bloodcult-addtarget-help = Использование: bloodcult_addtarget <ckey>
...
bloodcult-addtarget-success = Добавлена { $name } как цель культа.

# Remove Target Command
bloodcult-removetarget-description = Удалить цель для Культа Крови
bloodcult-removetarget-help = Использование: bloodcult_removetarget <ckey>
...
bloodcult-removetarget-success = Удалена { $name } как цель культа.

# List Targets Command
bloodcult-listtargets-description = Показать все текущие цели Культа Крови
bloodcult-listtargets-help = Использование: bloodcult_listtargets
...
bloodcult-listtargets-header = Текущие цели культа ({ $count }):
