...
tips-dataset-139 = Обязательно мойте нелегальные имплантеры мылом после использования! Детективы могут просканировать использованные имплантеры на наличие уличающих следов ДНК, но только если они не были начисто вытерты.
