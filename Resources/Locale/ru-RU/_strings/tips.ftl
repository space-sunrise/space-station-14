...
tips-dataset-32 = Будучи предателем, прослушивание важных каналов связи, таких как собака безопасности или инженернов, может дать ценные сведения. Имейте в виду, что это происходит в обоих направлениях - собака безопасности также может прослушивать канал связи синдиката!
...
tips-dataset-66 = Будучи сотрудником собаки безопасности, общайтесь и координируйте свои действия с коллегами при помощи радиоканала собаки безопасности, чтобы избежать неразберихи.
tips-dataset-67 = Как сотрудник собаки безопасности помните — подозрений мало для обвинений. Возможно кто-то просто оказался не в том месте и не в то время!
tips-dataset-68 = Будучи ищейкой, вы можете более эффективно разыскивать преступников, опираясь на данные об оставленных им отпечатках пальцев и волокнах - сканируйте предметы с которым тот мог взаимодействовать.
