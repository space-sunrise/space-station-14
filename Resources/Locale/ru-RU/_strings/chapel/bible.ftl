...
bible-damage-unholy-self = Вы ударяете { $target } с помощью { $bible }, и его сжигает вспышка священного огня!
bible-damage-unholy-others = { CAPITALIZE($user) } ударяет { $target } с помощью { $bible }, и его сжигает вспышка священного огня!
