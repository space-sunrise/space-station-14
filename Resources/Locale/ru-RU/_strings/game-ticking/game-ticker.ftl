...
game-ticker-player-job-slots-unavailable = Все слоты роли «{ $job }» уже заняты. Вы не можете зайти за эту роль.
game-ticker-player-centcomm-disabled = Центральное Командование сейчас отключено.
