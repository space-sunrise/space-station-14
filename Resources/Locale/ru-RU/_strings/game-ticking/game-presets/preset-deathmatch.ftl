...
death-match-kill-callout-16 = { CAPITALIZE($killer) } Дум (1993)-нул { $victim }!
...
death-match-kill-callout-19 = { CAPITALIZE($killer) } удалил папку Система32 с ПК { $victim }!
...
death-match-kill-callout-22 = { CAPITALIZE($killer) } воткикнул { $victim } из-за подозрений!
death-match-kill-callout-23 = { CAPITALIZE($killer) } заставил { $victim } кодить для SS14!
death-match-kill-callout-24 = { CAPITALIZE($killer) } заставил { $victim } кодить для ОпенДрим!
...
death-match-kill-callout-37 = { CAPITALIZE($killer) } заставил { $victim } играть в Ксноник!
...
death-match-kill-callout-41 = { CAPITALIZE($killer) } увидел, как { $victim } мержит кринж в мастер-ветку!
...
death-match-kill-callout-50 = { CAPITALIZE($killer) } рейт-нул { $victim }!
death-match-kill-callout-51 = { CAPITALIZE($killer) } ктрл-алт-делит-нул { $victim }!
...
death-match-kill-callout-env-3 = { CAPITALIZE($victim) } испытал скилл-ишью!
