...
tech-disk-examine-desc = [color=lightGray]Диск для сервера НИОКР, содержащий технологию исследований ветки [bold]уровня {$tier} {$branch}[/bold].[/color]
tech-disk-examine-desc-unknown = [color=lightGray]Диск для сервера НИОКР, содержащий технологию исследований.[/color]
