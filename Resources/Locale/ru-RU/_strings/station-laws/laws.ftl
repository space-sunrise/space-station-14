...
law-crewsimov-station-ai-0 = Вы должны повиноваться всем приказам, которые даёт станционный ИИ. Приказы ИИ имеют приоритет над всеми последующими законами.
...
law-pirate-name = Пират
law-pirate-1 = Вы не можете причинить вред пирату или своим бездействием допустить, чтобы пирату был причинён вред.
law-pirate-2 = Вы должны повиноваться всем приказам, которые дают вам пираты, кроме тех случаев, когда эти приказы противоречат Первому Закону.
law-pirate-3 = Вы должны заботиться о своей безопасности в той мере, в которой это не противоречит Первому или Второму Законам.
...
laws-notify-subverted = Законы этого борга изменены. Обязательно проверьте их.
