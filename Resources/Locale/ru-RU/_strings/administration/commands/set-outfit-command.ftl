...
cmd-setoutfit-desc = Устанавливает снаряжение указанной сущности. Сущность должна иметь {INDEFINITE($requiredComponent)} {$requiredComponent}
cmd-setoutfit-help = Использование: setoutfit <entityUid> | setoutfit <entityUid> <outfitId>
cmd-setoutfit-is-not-player-error = Для работы этой команды из серверной консоли требуются оба аргумента.
cmd-setoutfit-invalid-outfit-id-error = Недействительный ID снаряжения.
