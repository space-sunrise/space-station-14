...
reagent-name-tranexamicacid = транексамовая кислота
reagent-desc-tranexamicacid = Препарат, способствующий свёртыванию крови, применяемый для остановки обильного кровотечения. При передозировке вызывает ещё более сильное кровотечение. Часто встречается в экстренных медипенах.
...
reagent-name-potassiumiodide = иодид калия
reagent-desc-potassiumiodide = Снижает разрушительное воздействие радиации на 90%. Используется только в профилактических целях.
