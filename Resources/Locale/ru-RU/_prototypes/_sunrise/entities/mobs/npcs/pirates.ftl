...
ent-PirateSquadT1LMGTimed = спавнер отряда пиратов (пулемёт)
    .suffix = Деспавн
    .desc = Спавнит отряд с лидером-ветераном, двумя стрелками, медиком и пулемётчиком с пулемётом.
ent-PirateSquadT1BreachTimed = спавнер отряда пиратов (штурм)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд ближнего боя с поддержкой медика и бомбардира.
ent-PirateSquadT1AssaultTimed = спавнер отряда пиратов (атака)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд с ветераном-командиром и бойцами линии.
ent-PirateSquadT1HeavyTimed = спавнер отряда пиратов (тяжёлый)
    .suffix = Деспавн
    .desc = Спавнит тяжёлый отряд со штурмовым боргом и огневой поддержкой.
ent-PirateSquadT1InfiltratorTimed = спавнер отряда пиратов (инфильтратор)
    .suffix = Деспавн
    .desc = Спавнит отряд инфильтраторов с ветераном-лидером с ПП и тремя рейдерами.
ent-PirateSquadT1MonkeyTimed = спавнер отряда пиратов (обезьяны)
    .suffix = Деспавн
    .desc = Спавнит ветерана-шахтёра и от четырёх до пяти обезьян разных типов.

ent-PirateSquadT1RandomTimed = спавнер отряда пиратов (случайный T1)
    .suffix = Деспавн
    .desc = Спавнит случайный отряд пиратов T1.
ent-PirateSquadT2LMGTimed = спавнер отряда пиратов (T2 пулемёт)
    .suffix = Деспавн
    .desc = Спавнит отряд пиратов T2 с пулемётной поддержкой.
ent-PirateSquadT2BreachTimed = спавнер отряда пиратов (T2 штурм)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд пиратов T2.
ent-PirateSquadT2AssaultTimed = спавнер отряда пиратов (T2 атака)
    .suffix = Деспавн
    .desc = Спавнит атакующий отряд пиратов T2.
ent-PirateSquadT2HeavyTimed = спавнер отряда пиратов (T2 тяжёлый)
    .suffix = Деспавн
    .desc = Спавнит тяжёлый отряд пиратов T2.
ent-PirateSquadT2InfiltratorTimed = спавнер отряда пиратов (T2 инфильтратор)
    .suffix = Деспавн
    .desc = Спавнит отряд инфильтраторов пиратов T2.
ent-PirateSquadT2ControlTimed = спавнер отряда пиратов (T2 контроль)
    .suffix = Деспавн
    .desc = Спавнит отряд контроля пиратов T2.
ent-PirateSquadT2AntiCrowdTimed = спавнер отряда пиратов (T2 анти-толпа)
    .suffix = Деспавн
    .desc = Спавнит отряд пиратов T2 против толпы.
ent-PirateSquadT2RandomTimed = спавнер отряда пиратов (случайный T2)
    .suffix = Деспавн
    .desc = Спавнит случайный отряд пиратов T2.
ent-PirateSquadT3LMGTimed = спавнер отряда пиратов (T3 пулемёт)
    .suffix = Деспавн
    .desc = Спавнит отряд пиратов T3 с пулемётной поддержкой.
ent-PirateSquadT3BreachTimed = спавнер отряда пиратов (T3 штурм)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд пиратов T3.
ent-PirateSquadT3AssaultTimed = спавнер отряда пиратов (T3 атака)
    .suffix = Деспавн
    .desc = Спавнит атакующий отряд пиратов T3.
ent-PirateSquadT3HeavyTimed = спавнер отряда пиратов (T3 тяжёлый)
    .suffix = Деспавн
    .desc = Спавнит тяжёлый отряд пиратов T3.
ent-PirateSquadT3InfiltratorTimed = спавнер отряда пиратов (T3 инфильтратор)
    .suffix = Деспавн
    .desc = Спавнит отряд инфильтраторов пиратов T3.
ent-PirateSquadT3ShieldPhalanxTimed = спавнер отряда пиратов (T3 фаланга щитов)
    .suffix = Деспавн
    .desc = Спавнит отряд пиратов T3 с построением «щитовая фаланга».
ent-PirateSquadT3SuppressorTimed = спавнер отряда пиратов (T3 подавление)
    .suffix = Деспавн
    .desc = Спавнит отряд подавления пиратов T3.
ent-PirateSquadT3UniversalTimed = спавнер отряда пиратов (T3 универсальный)
    .suffix = Деспавн
    .desc = Спавнит универсальный отряд пиратов T3.
ent-PirateSquadT3RandomTimed = спавнер отряда пиратов (случайный T3)
    .suffix = Деспавн
