...
ent-MobPirateT1MedicTimed = { ent-MobPirateT1Medic }
    .suffix = Деспавн
    .desc = { ent-MobPirateT1Medic.desc }
...
ent-MobPirateT1LMGSquadTimedSpawner = спавнер отряда пиратов (лпп)
    .suffix = Деспавн
    .desc = Спавнит отряд с лидером-ветераном, двумя стрелками, медиком и пулемётчиком с ЛПП.
ent-MobPirateT1BreachSquadTimedSpawner = спавнер отряда пиратов (штурм)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд ближнего боя с поддержкой медика и бомбардира.
ent-MobPirateT1AssaultSquadTimedSpawner = спавнер отряда пиратов (атака)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд с ветераном-командиром и бойцами линии.
ent-MobPirateT1HeavySquadTimedSpawner = спавнер отряда пиратов (тяжёлый)
    .suffix = Деспавн
    .desc = Спавнит тяжёлый отряд со штурмовым боргом и огневой поддержкой.
ent-MobPirateT1InfiltratorSquadTimedSpawner = спавнер отряда пиратов (инфильтратор)
    .suffix = Деспавн
    .desc = Спавнит отряд инфильтраторов с ветераном-лидером с ПП и тремя рейдерами.
ent-MobPirateT1MonkeySquadTimedSpawner = спавнер отряда пиратов (обезьяны)
    .suffix = Деспавн
    .desc = Спавнит ветерана-шахтёра и от четырёх до пяти обезьян разных типов.

ent-MobPirateT1RandomSquadTimedSpawner = спавнер отряда пиратов (случайный T1)
    .suffix = Деспавн
    .desc = Спавнит случайный отряд пиратов T1.
ent-MobPirateT2LMGSquadTimedSpawner = спавнер отряда пиратов (T2 ЛПП)
    .suffix = Деспавн
    .desc = Спавнит отряд пиратов T2 с пулемётной поддержкой.
ent-MobPirateT2BreachSquadTimedSpawner = спавнер отряда пиратов (T2 штурм)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд пиратов T2.
ent-MobPirateT2AssaultSquadTimedSpawner = спавнер отряда пиратов (T2 атака)
    .suffix = Деспавн
    .desc = Спавнит атакующий отряд пиратов T2.
ent-MobPirateT2HeavySquadTimedSpawner = спавнер отряда пиратов (T2 тяжёлый)
    .suffix = Деспавн
    .desc = Спавнит тяжёлый отряд пиратов T2.
ent-MobPirateT2InfiltratorSquadTimedSpawner = спавнер отряда пиратов (T2 инфильтратор)
    .suffix = Деспавн
    .desc = Спавнит отряд инфильтраторов пиратов T2.
ent-MobPirateT2ControlSquadTimedSpawner = спавнер отряда пиратов (T2 контроль)
    .suffix = Деспавн
    .desc = Спавнит отряд контроля пиратов T2.
ent-MobPirateT2AntiCrowdSquadTimedSpawner = спавнер отряда пиратов (T2 анти-толпа)
    .suffix = Деспавн
    .desc = Спавнит отряд пиратов T2 против толпы.
ent-MobPirateT2RandomSquadTimedSpawner = спавнер отряда пиратов (случайный T2)
    .suffix = Деспавн
    .desc = Спавнит случайный отряд пиратов T2.
ent-MobPirateT3LMGSquadTimedSpawner = спавнер отряда пиратов (T3 ЛПП)
    .suffix = Деспавн
    .desc = Спавнит отряд пиратов T3 с пулемётной поддержкой.
ent-MobPirateT3BreachSquadTimedSpawner = спавнер отряда пиратов (T3 штурм)
    .suffix = Деспавн
    .desc = Спавнит штурмовой отряд пиратов T3.
ent-MobPirateT3AssaultSquadTimedSpawner = спавнер отряда пиратов (T3 атака)
    .suffix = Деспавн
    .desc = Спавнит атакующий отряд пиратов T3.
ent-MobPirateT3HeavySquadTimedSpawner = спавнер отряда пиратов (T3 тяжёлый)
    .suffix = Деспавн
    .desc = Спавнит тяжёлый отряд пиратов T3.
ent-MobPirateT3InfiltratorSquadTimedSpawner = спавнер отряда пиратов (T3 инфильтратор)
    .suffix = Деспавн
    .desc = Спавнит отряд инфильтраторов пиратов T3.
ent-MobPirateT3SuppressorSquadTimedSpawner = спавнер отряда пиратов (T3 подавление)
    .suffix = Деспавн
    .desc = Спавнит отряд подавления пиратов T3.
ent-MobPirateT3UniversalSquadTimedSpawner = спавнер отряда пиратов (T3 универсальный)
    .suffix = Деспавн
    .desc = Спавнит универсальный отряд пиратов T3.
ent-MobPirateT3RandomSquadTimedSpawner = спавнер отряда пиратов (случайный T3)
    .suffix = Деспавн
