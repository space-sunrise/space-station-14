...
ent-ClothingOuterCoatArbiter = плащ Арбитра
    .desc = Структурный плащ с чёрными полотнищами, золотой фурнитурой и почти полным отсутствием мягкости. Похож на форменную вещь после спора с военной доктриной.
