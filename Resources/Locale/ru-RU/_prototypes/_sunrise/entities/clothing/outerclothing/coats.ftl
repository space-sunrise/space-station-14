...
ent-ClothingOuterCoatSecurityOvercoat = шинель службы безопасности
    .desc = Легкобронированная кожаная шинель, предназначенная для повседневной носки высокопоставленными офицерами. Имеет логотип компании НаноТрейзен Секьюрити.
...
ent-ClothingOuterCoatNtrepOpen = растёгнутый пиджак представителя НТ
...
ent-ClothingOuterCoatCaptainOvercoat = капитанская шинель
    .desc = Селанная специально под замеры действующего капитана и сделанный лучшими швеями НаноТрейзен.
