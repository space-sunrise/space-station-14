...
ent-ClothingOuterHardsuitBlueShield = скафандр пса «Синий щит»
...
ent-ClothingOuterHardsuitPilot = скафандр пилота Собаки безопасности
    .desc = Облегчённая версия скафандра Собаки безопасности, обеспечивает хорошую подвижность, но меньшую защиту.
...
ent-ClothingOuterEliteHardsuitUSSP = Бронескафандр Спартак-К
    .desc = Бронескафандр высшего пса состава СССП, разработанный конструкторским бюро "Титан". Обладает выдающимися характеристиками защиты, сочетающими прочность и устойчивость к различным видам повреждений. Благодаря передовым технологиям он обеспечивает не только надежную защиту, но и максимальную мобильность для эффективного управления войсками в боевых условиях.
    .suffix = Санрайз, СССП
