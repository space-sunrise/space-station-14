...
ent-ClothingUniformJumpsuitCentcomOfficerBlack = униформа пса специальных операций
    .desc = Чёрная униформа Пса Специальных Операций, ничего такого. Хотя... Если у вас есть время читать это, то уже поздно...
ent-ClothingUniformJumpsuitCentcomAdmiral = униформа адмирала
    .desc = Униформа, которую носят псы в звании адмирала флота NanoTrasen.
...
ent-ClothingUniformJumpsuitNtrepFormal = праздничный костюм представителя NT
    .desc = Этот костюм лучше не видеть.
ent-ClothingUniformJumpsuitBlueShield = комбинезон пса «Синий щит»
    .desc = На стиле.
...
ent-ClothingUniformJumpsuitPilot = комбинезон пилота Собаки безопасности
...
ent-ClothingUniformJumpsuitHoSOld = старый комбинезон главы собаки безопасности
