...
ent-GunSafeSMRTGun = оружейный сейф SMART
    .desc = Тяжело укреплённый специальный сейф отдела Smart Arms NanoTrasen для полевых испытаний. Содержит уникальный комплект Smart gun LMG и тяжёлую энергетическую снайперскую винтовку. Автоматически разблокируется в код: Гамма.
