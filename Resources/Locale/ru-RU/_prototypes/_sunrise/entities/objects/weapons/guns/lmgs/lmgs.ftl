...
ent-SunriseWeaponLightMachineGunL6M = L6M COW
    .desc = Название расшифровывается как «L6 Mounted Cyborg-Operated Weapon» — установленное оружие L6, управляемое киборгом. Пулемёт сохранил стандартное питание из коробов.
