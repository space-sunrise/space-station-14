...
ent-WeaponMachineGunMG42 = MG-342
    .desc = Скорострельный пулемёт ОПЗ, адаптированный под современные боеприпасы. Использует ленточное питание патронами 7.62×51 НТ. Подходит для подавления целей и удержания позиций. Не предназначен для точной или длительной стрельбы.
