...
ent-WeaponPistolM1984 = D1984
    .desc = Компактный пистолет, созданный в рамках директивы внутреннего порядка НаноТрейзен «N1984». Личное оружие контроля, дисциплины и точного воздействия. Выдаётся отличившимся детективам за надёжность в ходе оперативных расследований. Использует магазины .35 авто.
