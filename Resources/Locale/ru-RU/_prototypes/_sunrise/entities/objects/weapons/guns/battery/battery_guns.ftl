...
ent-SunriseWeaponLaserCarbineBattery = батарейный лазерный карабин
    .desc = Батарейная версия стандартного лазерного карабина службы безопасности NanoTrasen.
...
ent-WeaponEnergyGunPistol = энерго-пистолет «Судья»
    .desc = Энерго-пистолет службы безопасности мог бы стать стандартным табельным оружием, если бы не тотальная экономия «NanoTrasen». Имеет три режима стрельбы: станнер, тазер и лазер.
