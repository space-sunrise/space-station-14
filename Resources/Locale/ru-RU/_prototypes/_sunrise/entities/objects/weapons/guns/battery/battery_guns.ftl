...
ent-WeaponPilotLasgun = пилотский лазган
    .desc = Компактный лазган образца СБ с освящённым зарядным блоком и прикладом, острым как последний довод. Его машинный дух гудит так, будто ждёт короткую молитву перед взлётом.
