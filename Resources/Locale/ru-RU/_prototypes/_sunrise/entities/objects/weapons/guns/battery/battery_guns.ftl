...
ent-WeaponLaserLNT620 = LNT620 «Искра»
    .desc = Автоматический батарейный лазер НаноТрейзен LNT620 "Искра"
...
ent-WeaponSniperPulseCarbine = Тяжелый импульсный карабин
    .desc = Высокотехнологичный тяжелый снайперский импульсный карабин, который предпочитают оперативники ОБР НаноТрейзен.
