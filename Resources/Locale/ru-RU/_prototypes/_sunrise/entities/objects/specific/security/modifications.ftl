...
ent-LecterMk3Upgrade = комплект Лектер Мк3
    .desc = Продвинутый комплект модификации, превращающий Лектер Мк2 в Лектер Мк3.
...
ent-VestSecUpgrade = комплект улучшения (жилет службы безопасности)
    .desc = Набор доработки для стандартного жилета службы безопасности. Заменяет дешёвое защитное волокно на высококачественный синтетический материал, превращая его в прочную, высококачественную версию. Также добавляет пару подсумков, которые не ограничивают движения.
