...
ent-DrozdUpgrade = комплект (Дрозд)
...
ent-LecterUpgrade = комплект (Лектер)
...
ent-VestSecUpgradeBullet = комплект (противопульный бронежилет)
    .desc = Комплект модернизации противопульного жилета. Заменяет стальные пластины на многослойные композиты, обеспечивая максимальную защиту от пуль. без потери в мобильности.
