...
ent-BeerMedipen = пивной медипен
    .desc = Одноразовый медипен, наполненный пивом.
...
ent-HyposprayMedicalNoFilterBox = взломанный медицинский гипоспрей
    .desc = Ящик, содержащий стерильный инжектор для быстрого введения лекарств пациентам. Внутренний токсиновый фильтр был удалён во время взлома. Упаковка разрушается при открытии, не оставляя следов.
