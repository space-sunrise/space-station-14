...
ent-WeaponCrusherGlaiveBorg = встроенная глефа-крушитель
    .desc = Ранний дизайн прото-кинетического ускорителя в форме глефы. Модифицирована для использования киборгами.