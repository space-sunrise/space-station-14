...
ent-RadioJammerSyndicateBorg = глушитель связи киборга
    ...
    .suffix = Синдикат
ent-SunriseSyndiBorgHypo = гипоспрей киборга «Горлекс»
    .desc = Перезаправляемый гипоспрей «Горлекс», приспособленный для использования киборгами.
ent-SunriseAutoMenderBruteSyndicateBorg = автомендер травм Синдиката
    .desc = Перезаправляемый автомендер, настроенный на лечение механических травм.
ent-SunriseAutoMenderBurnSyndicateBorg = автомендер ожогов Синдиката
    .desc = Перезаправляемый автомендер, настроенный на лечение ожогов.
