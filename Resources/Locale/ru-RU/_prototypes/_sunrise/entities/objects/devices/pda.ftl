...
ent-NtrGuardPDA = КПК оперативника ИСН
    .desc = КПК для самых маленьких.
ent-NtrLeadGuardPDA = КПК лидера ИСН
    .desc = КПК для кулака закона.
ent-MailCarrierPDA = КПК почтальона
    .desc = КПК почтальона, пропах навозом и потом от перетаскивания двух тонн кирпичей.
