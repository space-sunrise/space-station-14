...
ent-CrateArmoryMagazineBoxLightRifleBig = ящик патронов .30 винтовочные
    .desc = Содержит два ящика патрон калибра .30, в сумме 400 патрон. Чтобы открыть необходим доступ уровня Оружейной.
ent-CrateArmoryMagazineBoxRifleBig = ящик патронов .20 винтовочные
    .desc = Содержит два ящика патрон калибра .20, в сумме 400 патрон. Чтобы открыть необходим доступ уровня Оружейной.