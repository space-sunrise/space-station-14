...
ent-CrateSecurityHoly = ящик с набором экзорциста
    .desc = Ящик содержит две коробки святых патронов, три чеснока, флягу святой воды и иногда Библию. Чтобы открыть необходим уровень доступа Службы безопасности. Амено до́ри ме Амено!
ent-CrateSecurityDebugArmorCrate = ящик с различной бронёй
    .suffix = Дебаг
    .desc = Содержит набор различной базовой брони и комплектов улучшения. Для открытия требуется уровень доступа Службы Безопасности.
