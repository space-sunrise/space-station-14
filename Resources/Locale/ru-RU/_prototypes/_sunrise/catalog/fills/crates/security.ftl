...
ent-CrateSecuritySWAT = ящик с бронёй SWAT
    .desc = Ящик, Содержит комплект Спецназа. Две брони SWAT, два шлема спецназа, два противогаза спецназа и боевые ботинки спецназа. Чтобы открыть необходим уровень доступа Службы Безопастности.
