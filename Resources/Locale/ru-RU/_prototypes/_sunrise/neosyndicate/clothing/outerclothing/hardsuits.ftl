ent-ClothingOuterHardsuitStalker = скафандр сталкера Cybersun
    .desc = Новейший скафандр, созданный отделом передовых исследований и разработок компании Cybersun. Ещё не вошел в массовое производство, вероятно, даже не запатентован.
