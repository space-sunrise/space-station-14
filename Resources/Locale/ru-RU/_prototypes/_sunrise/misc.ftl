...
ent-WeaponEnergyMagnum = энергетический магнум
    .desc = Мощный самозаряжающийся энергетический пистолет для элитного персонала собаки безопасности. Имеет три режима огня: высокий урон, пробитие окон и нелетальный оглушающий.
