...
ent-ClothingBackpackDuffelSyndicateFilledLMG = набор "L6 Saw"
    .desc = Еще больше дакки: культовый лёгкий пулемет L6 в комплекте с 3 коробами патронов по 200 патронов каждый. Штурмовая версия.
ent-ClothingBackpackDuffelSyndicateFilledLMGMax = набор L6 MAX
    .desc = Ещё больше дакки: утяжелённый пулемёт L6 MAX в комплекте с тремя коробами калибра .308 по 100 патронов. Усиленный ствол и мощный патрон позволяют подавлять противника шквальным огнём и разносить укрытия в щепки, но за эту мощь приходится расплачиваться громоздкостью и сниженной мобильностью.
