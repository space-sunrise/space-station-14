...
ent-ClothingBackpackDuffelSyndicateFilledLMGMax = набор "L6 MAX"
    .desc = Ещё больше дакки: утяжелённый пулемёт L6 MAX в комплекте с тремя коробами патронов калибра .308. Усиленный ствол и мощный патрон позволяют подавлять противника шквальным огнём и разносить укрытия в щепки, но за эту мощь приходится расплачиваться громоздкостью и сниженной мобильностью.
