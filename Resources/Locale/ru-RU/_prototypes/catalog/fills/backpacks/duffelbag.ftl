...
ent-ClothingBackpackDuffelSyndicateFilledLMG = набор "Л6 сау"
    .desc = Еще больше дакки: культовый лёгкий пулемет Л6 в комплекте с 3 коробами патронов по 200 патронов каждый. Штурмовая версия.
