...
ent-CrateSecurityRiot = ящик со снаряжением спецназа
    .desc = Содержит два комплекта противоударной брони, шлемов, щитов и дубинок, заряженных резиновыми пулями. Включает дополнительные боеприпасы. Требуется доступ в арсенал для открытия.
