...
ent-CrateTrainingBombs = учебные бомбы
    .desc = Содержит три маломощные учебные бомбы для обучения персонала собаки безопасности обезвреживанию и безопасному уничтожению боеприпасов. Защитный костюм EOD не включен. Требуется доступ к оружейной для открытия.
