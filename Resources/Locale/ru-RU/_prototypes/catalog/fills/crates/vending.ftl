...
ent-CrateVendingMachineRestockSmokesFilled = ящик пополнения шейдисигз делюкс
    .desc = Содержит два набора пополнения торгоматов ШейдиСигз Делюкс.
...
ent-CrateVendingMachineRestockChangFilled = ящик пополнения Мистера Ченга
    .desc = Содержит набор пополнения торгомата Мистера Ченга.
ent-CrateVendingMachineRestockDiscountDansFilled = ящик пополнения дискаунт дэнс
    .desc = Содержит набор пополнения торгомата Дискаунт Дэнс.
ent-CrateVendingMachineRestockDonutFilled = ящик пополнения донат
    .desc = Содержит набор пополнения торгомата Монкин Донатс.
