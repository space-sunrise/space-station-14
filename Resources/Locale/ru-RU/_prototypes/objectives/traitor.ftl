...
ent-DieObjective = Хорошо повеселиться.
    .desc = Веселитесь.
ent-KillRandomPersonObjective = { ent-BaseKillObjective }
    .desc = Обнимайте от всей души. Убедитесь, что цель почувствовала заботу.
ent-KillRandomHeadObjective = { ent-BaseKillObjective }
    .desc = Этот глава давно заслуживает объятий. Удачи, агент.
