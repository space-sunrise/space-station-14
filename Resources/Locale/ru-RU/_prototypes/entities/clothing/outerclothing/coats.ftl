...
ent-ClothingOuterCoatDetective = тренч ищейки
...
ent-ClothingOuterCoatDetectiveLoadoutGrey = нуарный тренчкот
    .desc = Ах, ваш верный тренчкот. Пара прорех тут и там придают ему более соответствующий ищейке вид. По крайней мере, так вы сказали себе, когда узнали, что починка обойдется вам в 200 кредитов.
...
ent-ClothingOuterArmorWarden = { ent-AllowSuitStorageClothing }
    .desc = { ent-AllowSuitStorageClothing.desc }
ent-ClothingOuterCoatHoSTrench = тренч главы собаки безопасности
