...
ent-ClothingHeadHelmetERTSecurity = шлем пса безопасности ОБР
    .desc = Атмосферный шлем, который носят псы безопасности отрядов быстрого реагирования NanoTrasen. Имеет красный фонарь.
...
ent-ClothingHeadHelmetJustice = шлем справедливости
    .desc = Продвинутое оборудование для собаки безопасности. Защищает станцию от злодеев.
