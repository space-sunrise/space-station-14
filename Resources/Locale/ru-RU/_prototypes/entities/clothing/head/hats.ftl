...
ent-ClothingHeadHatBeretSecurity = берет охраны
    .desc = Стильный вариант одежды для сотрудников собаки безопасности.
...
ent-ClothingHeadHatBeretHoS = берет главы собаки безопасности
    .desc = Чёрный берет с вышитой командирской эмблемой. Для псов, которые предпочитают стиль безопасности.
ent-ClothingHeadHatBeretWarden = берет смотрителя
    .desc = Фирменный голубой берет с эмблемой смотрителя. Для псов, которые предпочитают стиль безопасности.
...
ent-ClothingHeadHatHoshat = шляпа главы собаки безопасности
    .desc = Верная фуражка стандартного образца начальника собаки безопасности. Чтобы показать псам, кто здесь командует.
...
ent-ClothingHeadHatWarden = фуражка смотрителя
    .desc = Фуражка пса полиции. Эта фуражка подчёркивает, что вы - ЗАКОН.
...
ent-ClothingHeadHatCentcomcap = фуражка Центком
    .desc = Экстравагантная, причудливая фуражка пса Центрального командования.
