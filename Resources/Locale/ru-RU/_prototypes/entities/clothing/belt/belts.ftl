...
ent-ClothingBeltSecurity = пояс охраны
    .desc = Может вмещать различное снаряжение собаки безопасности, такое как наручники и вспышки.
ent-ClothingBeltSheath = сабельные ножны
    .desc = Украшенные ножны, предназначенные для хранения псиного клинка.
...
ent-ClothingBeltSecurityWebbing = РПС охраны
    .desc = Уникальный, универсальный разгрузочный жилет с ремнями и поясом, может вмещать снаряжение собаки безопасности.
