...
ent-ClothingNeckCloakAdmin = вех!-плащ
    .desc = Вех!
ent-ClothingNeckCloakSalvagerSupreme = крутой плащ утилизатора
    .desc = Носят самые опытные утилизаторы, те, кто овладел космосом и сделал астероид для добычи своей вотчиной. Такие вещи просто так не раздают, знаете ли?
