...
ent-EmergencyLight = аварийный свет
    .desc = Маленький светильник с внутренней батареей, который включается, как только перестает получать питание. Технология нанотрейзен позволяет ему адаптировать свой цвет, чтобы предупредить экипаж об условиях на станции.
