...
ent-VendingMachineSec = СБТех
    .desc = Торговый автомат с экпипировкой СБ. На табличке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ СОБАКИ БЕЗОПАСНОСТИ".
...
ent-VendingMachineDetDrobe = ИщейкоШкаф
    .desc = Машина для всех ваших нужд ищейки, до тех пор, пока вам нужна одежда.
