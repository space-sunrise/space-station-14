...
ent-DefibrillatorSyndicate = дефибриллятор Interdyne
    .desc = Особый дефибриллятор фирмы Interdyne. Вводит в сердце смесь из омнизина, эпинефрина и некросола даже в живых пациентов. Может использоваться для защиты, но не слишком эффективен в ближнем бою.
