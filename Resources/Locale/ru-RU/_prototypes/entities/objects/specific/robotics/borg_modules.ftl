...
ent-XenoborgModuleDoorControl = модуль управления дверью ксеноборга
    .desc = Модуль, который позволяет ксеноборгам управлять шлюзами.
ent-XenoborgModuleXray = рентгеновский модуль ксеноборга
    .desc = Модуль с рентгеновской пушкой.
ent-XenoborgModuleTurboLaser = турбо-лазерный модуль ксеноборга
    .desc = Модуль с тяжелым пулеметным лазером.
