...
# Sunrise-Edit - описание выбора типа боеприпаса
ent-WeaponMechCombatHeavyRifle = Тяжёлая винтовка для меха
    .desc = Тяжёлая винтовка для боевых мехов с выбором бронебойных, антиматериальных и экспансивных патронов. Система подачи боеприпасов настраивается на самой пушке перед установкой.
    .suffix = Оружие меха, Винтовка, Боевое, Выбор боеприпасов
...
ent-WeaponMechCombatUltraRifle = AC-2 "Ультра"
    .desc = Навесной карабин, стреляющий винтовочными патронами.
