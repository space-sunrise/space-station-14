...
ent-MechNTGygax = Особый гигакс НаноТрейзен
    .desc = Козырь НаноТрейзен при решении проблем. Высокая прочность, повышенная защита от ударов, взрывов, температуры, выстрелов: обычных, лазерных и энергетических, а также расширенные слоты под оборудование позволяют перевернуть ситуацию на станции. Ускорители потребляют колоссальное количество энергии.
