...
ent-SecurityCadetPDA = КПК щенка СБ
...
ent-ERTSecurityPDA = КПК пса безопасности ОБР
    .suffix = Пес безопасности
...
ent-SeniorOfficerPDA = КПК гончей СБ
