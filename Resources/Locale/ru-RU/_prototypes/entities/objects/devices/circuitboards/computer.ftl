...
ent-SalvageJobBoardComputerCircuitboard = компьютерная плата доски заданий по утилизации
    .desc = Компьютерная печатная плата для компьютера доски заданий по утилизации.
