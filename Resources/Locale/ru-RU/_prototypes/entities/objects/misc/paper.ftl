...
ent-PaperNanoTaskItem = элемент задания из НаноЗадачи
    .desc = Распечатанное задание из НаноЗадачи. Можно вставить в ваш КПК, чтобы добавить его в список задач.
