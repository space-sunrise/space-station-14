...
ent-TrackingImplant = имплант Трекер
    .desc = Этот имплант оснащён устройством слежения, подключенным к сети датчиков комбинезонов, а также монитором состояния для радиоканала собаки безопасности.
...
ent-FakeMindShieldImplant = имплант Поддельный ментальный щит
    .desc = Этот имплант позволяет имплантатору создавать ложный сигнал, который используется ИЛС собаки безопасности NT для идентификации лиц с имплантированным ментальным щитом.
