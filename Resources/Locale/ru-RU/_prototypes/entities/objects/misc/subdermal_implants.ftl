...
ent-FakeMindShieldImplant = имплант Поддельный ментальный щит
    .desc = Этот имплант позволяет имплантатору создавать ложный сигнал, который используется ИЛС службы безопасности НТ для идентификации лиц с имплантированным ментальным щитом.
