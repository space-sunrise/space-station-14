...
ent-DeathRattleImplantBlueShield = имплант предсмертного хрипа синего щита
    .desc = Этот имплант сообщит на радиоканал Центкомма, если пользователь попадет в критическое состояние или умрет.
ent-DeathRattleImplantCentcomm = имплант предсмертного хрипа центрального командования
    .desc = Этот имплант сообщит на радиоканал Центкомма, если пользователь попадет в критическое состояние или умрет.
