...
ent-WeaponDisablerPractice = тренировочный станнер
    .desc = Оружие для самозащиты, которое изнуряет органические цели, пока они не свалятся с ног. Эта модель была урезана для щенков СБ и практически безвредна.
    .suffix = Пистолет
