...
ent-WeaponEnergyShotgunPractice = тренировочный энергетический дробовик
    .desc = Уникальный прототип энергетического оружия, который использует различные конфигурации дробовика. Эта модель была урезена для начинающих Глав СБ и практически безвредна