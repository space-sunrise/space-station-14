...
ent-EnergyShieldCyberBorg = robot bulwark
    .desc = A cyborg-integrated hard-light shield that can also project a solid but fragile holographic barrier.
ent-WeaponSprayNozzleBorg = robot spray nozzle
    .desc = An internal spray jet installed directly into a custodial cyborg, firing pressurized bursts of space cleaner just like a spray nozzle.
...
ent-WeaponProtoKineticHeavyBorg = proto-kinetic robot heavy accelerator
    .desc = What happens when you bolt a portable "Matter Dematerializer" onto a cyborg chassis. 
