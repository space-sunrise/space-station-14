...
ent-ClothingPantsWomanBlack = women's black thong
    .desc = A black thong.
ent-ClothingPantsManAdjutant = men's boxers "Adjutant"
    .desc = Boxers in adjutant colors.
ent-ClothingPantsManCMO = men's boxers "CMO"
    .desc = Boxers in chief medical officer colors.
ent-ClothingPantsManCaptain = men's boxers "Captain"
    .desc = Boxers in captain colors.
ent-ClothingPantsManHeadOfPersonnel = men's boxers "Head of Personnel"
    .desc = Boxers in head of personnel colors.
ent-ClothingPantsManHeadOfSecurity = men's boxers "Head of Security"
    .desc = Boxers in head of security colors.
ent-ClothingPantsManQuartermaster = men's boxers "Quartermaster"
    .desc = Boxers in quartermaster colors.
ent-ClothingPantsManResearchDirector = men's boxers "Research Director"
    .desc = Boxers in research director colors.
ent-ClothingPantsManBlueshield = men's boxers "Blueshield"
    .desc = Boxers in blueshield colors.
ent-ClothingPantsManChiefEngineer = men's boxers "Chief Engineer"
