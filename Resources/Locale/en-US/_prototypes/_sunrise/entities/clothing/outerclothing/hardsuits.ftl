...
ent-ClothingOuterEliteHardsuitUSSP = Spartak-K
    .desc = A heavily armored elite USSP spacesuit designed for combat operations in extreme conditions. Reinforced armor protects against firearms and energy weapons, radiation and explosions. It is used by high officer.
    .suffix = Sunrise, USSP
