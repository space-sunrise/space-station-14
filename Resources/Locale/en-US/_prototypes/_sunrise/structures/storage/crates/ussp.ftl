ent-CrateShelfMosin = old wooden crate
    .desc = A large wooden crate with faded paint and the emblem of the USSP. On the inside of the lid, a barely readable instruction explains the importance of the bayonet and which part of the rifle to hold to kill properly. Judging by the dust, it’s been waiting for centuries.
Warning: Instructions may be outdated by several centuries.
ent-WrappedMosin = wraped mosin rifle
