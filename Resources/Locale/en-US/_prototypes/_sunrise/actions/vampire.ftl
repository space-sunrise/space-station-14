ent-ActionVampireToggleFangs = Extend Fangs
    .desc = Feed on a blood-bearing creature with an empty hand. Movement, damage, a covered mouth or losing range interrupts feeding.

ent-ActionVampireGlare = Glare
    .desc = Drains nearby creatures and paralyzes those in front. Protected eyes can resist the effect.

ent-ActionVampireSleep = Sleep
