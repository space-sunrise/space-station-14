...
ent-ActionCreateSmokeGrenade = Create smoke grenade
    .desc = Channels suit power into creating a smoke grenade for tactical escape.
ent-ActionCreateFlashbangGrenade = Create flashbang grenade
    .desc = Channels suit power into creating a flashbang grenade for tactical distraction.
