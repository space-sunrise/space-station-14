...
ent-WeaponMechCombatHeavyRifle = Mounted Heavy Rifle Gun
    .desc = A battlemech-mounted heavy rifle with selectable armor-piercing, anti-materiel, and hollow-point ammunition. Its ammunition feed must be configured on the weapon before installation.
    .suffix = Mech Weapon, Gun, Combat, Selectable Ammo
...
ent-WeaponMechCombatUltraRifle = Ultra AC-2
    .desc = Mounted carbine, firing LightRifle cartridges.
...
ent-WeaponMechCombatAMLG90 = AMLG90
    .desc = Laser mounted machine gun.
    .suffix = Mech Weapon, Gun, Combat, Laser
ent-WeaponMechCombatXray = S-1 X-Ray Projector
    .desc = Experimental mech weapon that fires X-rays that pass through obstacles.
...
ent-WeaponMechCombatMissileRack8Frag = BRM-50 Missile Rack
    .desc = Tubes must be reloaded from the outside.
    .suffix = Mech Weapon, Gun, Combat, Missile
