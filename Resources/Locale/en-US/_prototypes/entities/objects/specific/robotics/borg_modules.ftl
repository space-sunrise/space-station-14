...
ent-XenoborgModuleXray = x-ray xenoborg module
    .desc = Module with an x-ray cannon gun.
ent-XenoborgModuleTurboLaser = turbo-laser xenoborg module
    .desc = Module with a heavy machinegun laser.
