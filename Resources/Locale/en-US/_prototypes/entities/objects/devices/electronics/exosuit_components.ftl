...
ent-PhazonArmorPlate = phazon armor plates
    .desc = Armor plates made of steel for Phazon exosuit.
...
ent-MechPhasicScanningModule = phasic scanning module
    .desc = An application part used in the construction of various devices.
