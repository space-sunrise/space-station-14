...
ent-MagazineMagnumRubber = pistol magazine (.45 magnum rubber)
    .desc = 7-round single stack pistol magazine. Intended to hold non-lethal kinetic ammunition.
...
ent-MagazineMagnumHP = pistol magazine (.45 magnum HP)
    .desc = 7-round single stack pistol magazine. Intended to hold hollow-point ammunition.
ent-MagazineMagnumFMJ = pistol magazine (.45 magnum FMJ)
    .desc = 7-round single stack pistol magazine. Intended to hold general-purpose kinetic ammunition.
