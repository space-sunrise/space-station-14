...
ent-GrenadeFlashBang = flashbang
    .desc = Eeeeeeeeeeeeeeeeeeeeee. But not in space 
...
ent-MetalFoamGrenade = metal foam grenade
    .desc = An emergency tool used for patching breaches with special quick-set metal foam. Almost as good as real walls.
