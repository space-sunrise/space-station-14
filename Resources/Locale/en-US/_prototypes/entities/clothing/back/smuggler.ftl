...
ent-ClothingBackpackSmugglerRevolutionaryFilled = revolutionary smuggler's satchel
    .suffix = Smuggler, Revolutionary, Do Not Map
    .desc = { ent-ClothingBackpackSatchelSmuggler.desc }
ent-RevolutionarySmugglerStash = wraped smuggler stash
    .suffix = Revolutionary
    .desc = { ent-BaseSubfloorAnchorStorage.desc }
