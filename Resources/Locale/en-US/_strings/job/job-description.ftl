...
job-description-ertchaplain-veteran = Ensure the station crew's last rights are taken care of. Veteran position requiring extensive experience.
job-description-ertengineer-veteran = Ensure that the station has power and clean air. Veteran position requiring extensive experience.
job-description-ertjanitor-veteran = Ensure that the station is properly cleaned--for morale. Veteran position requiring extensive experience.
job-description-ertleader-veteran = Lead the Emergency Response Team in dealing with threats to Nanotrasen assets. Veteran position requiring extensive experience.
job-description-ertmedic-veteran = Ensure that the crew of the station is kept alive and healthy. Veteran position requiring extensive experience.
job-description-ertsecurity-veteran = Ensure that any active threats to the station are put to rest. Veteran position requiring extensive experience.
job-description-cburn-veteran = Quarantine and contain biological threats. Veteran position requiring extensive experience.
