...
doc-text-printer-report-accomplishment-goals =
    ...
    =============================================
                                ⠀[italic]Место для печатей[/italic]
doc-text-printer-ussp-info =
[bold]Протокольный отчёт:[/bold] Выход сотрудника СССП из криосна


[bold]Дата выхода:[/bold]
12 лет, 3 месяца, 4 дня, 13 часов с момента входа в криосон.


[bold]Место нахождения при выходе из криосна:[/bold]
Неизвестно.


[bold]Причина выхода:[/bold]
Принудительный вывод из криосна в связи с аварийной ситуацией на станции.


[bold]Рекомендации:[/bold]
После выхода из криосна сотруднику рекомендуется воздержаться от физических нагрузок, чтобы избежать возможных осложнений после длительного криосна.


[bold]Статус систем станции:[/bold]
Системы станции работают в аварийном режиме. Некоторые основные функции могут быть нарушены или неактивны. Требуется срочная диагностика для определения характера повреждений и оценки общего состояния станции.


[bold]Действия:[/bold]
Сотруднику необходимо как можно скорее провести первичную оценку состояния станции, выявить критические неисправности и сообщить о текущей ситуации в командование. После диагностики важно приступить к экстренному ремонту для восстановления функционирования станции и обеспечения безопасности экипажа.


[bold]Дополнительная информация:[/bold]
В случае выявления угрозы для жизни и здоровья экипажа или возникновения непредвиденных ситуаций, сотрудник имеет право на принятие самостоятельных решений в соответствии с текущей обстановкой.
