...
ent-AmpulaBuccaneerSpirit = { ent-Ampula }
    .suffix = Buccaneer spirit
    .desc = A pirate ampoule filled with a suspiciously heroic emergency cocktail.
ent-AmpulaMurmillo = { ent-Ampula }
    .suffix = Murmillo
    .desc = A sealed ampoule filled with a regenerating combat stimulant mixture.
ent-AmpulaPirate = pirate ampula
    .desc = A reinforced pirate ampoule for emergency hardsuit injection systems.
