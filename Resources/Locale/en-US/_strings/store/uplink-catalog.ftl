...
uplink-mini-bomb-desc = If you don't care about accuracy, then this choice is for you.

uplink-cluster-mini-bomb-name = Cluster Minibomb
uplink-cluster-mini-bomb-desc = A low-yield, high-impact precision sabotage explosive with a 5 second long fuse. Perfect for quickly destroying a machine, dead body, or whatever else needs to go.
